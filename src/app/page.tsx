          ...
          <div className="mb-4 rounded-md border border-zinc-200 bg-zinc-50 p-3">
            <div className="flex flex-wrap items-start justify-between gap-3">
              <div>
                ...
                <h3 className="mt-1 text-sm font-semibold text-zinc-950">Monitor review profile</h3>
            ...
            <div className="mt-3 grid gap-2 sm:grid-cols-4 lg:grid-cols-8">
              ...
              <ReviewMetric label="AOS layers" value={alertReviewTable.monitorProfile.aosLayers.length} />
            ...
            <div className="mt-3 overflow-x-auto rounded-md border border-zinc-200 bg-white">
              <table className="w-full min-w-[780px] text-left text-xs">
                ...
                <tbody className="divide-y divide-zinc-200">
                  {alertReviewTable.monitorProfile.aosLayers.map((layer) => (
                    <tr key={layer.key}>
