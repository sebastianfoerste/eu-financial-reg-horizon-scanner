...
export type HorizonMonitorReviewLayer = {
  key:
...
export type HorizonMonitorProfile = {
  schema: "horizon-scanner.monitor-review";
  reviewLayers: HorizonMonitorReviewLayer[];
...
function buildMonitorProfile({
  ...
  return {
    ...
    externalActionAllowed: false,
    reviewNotice:
      "Local regulator-source evidence only. Alerts remain draft-only until reviewed delivery approval.",
  };
}
