...
export const mockPublications: PublicationListItem[] = [
  ...
  {
    id: "pub-eba-psd3-fraud",
    title: "Synthetic EBA note on PSD3 fraud reporting and confirmation of payee",
    sourceCode: "eba",
    sourceName: "EBA",
    sourceUrl: "https://www.eba.europa.eu/regulation-and-policy/payment-services-and-electronic-money",
    publicationType: "discussion_paper",
    publishedAt: "2026-05-22T09:00:00.000Z",
    fetchedAt: "2026-05-22T09:30:00.000Z",
    language: "en",
    bodyText:
      "Synthetic regulator publication for demo use. The paper discusses PSD3 and PSR fraud reporting, confirmation of payee controls, payment initiation service providers and account information service providers.",
    tags: {
      regulationFamilies: ["psd"],
      activities: ["payment_initiation", "account_information", "money_remittance"],
      licenceTypes: ["payment_institution_psd", "registered_account_information_service_provider"],
      topicPaths: ["consumer_protection.retail_disclosure", "conduct.complaints_handling"],
      jurisdictions: ["eu", "eba"],
    },
    confidence: 0.71,
    classifierModel: "deterministic-keyword-rules",
    classifierVersion: "stub:keyword-rules-v1",
    ...
    impactScore: 76,
    summary:
      "Synthetic EBA payments publication used to test PSD3, PSR, fraud reporting and confirmation-of-payee routing.",
    whatChanged:
      "The demo item creates a payment-services signal separate from crypto and DORA publications.",
    whoIsAffected:
      "Payment institutions, account information service providers, payment initiation service providers and payment product owners.",
    recommendedAction:
      "Review payment-fraud controls, customer disclosure wording and roadmap dependencies before issuing any client alert.",
    serviceOfferingIds: ["gc_psd_licence"],
    rawHash: "demo-eba-psd3-fraud",
    scoreRationale:
      "Activity overlap: payment_initiation, account_information, money_remittance; licence overlap: payment_institution_psd.",
    matchedLicences: ["payment_institution_psd", "registered_account_information_service_provider"],
    matchedActivities: ["payment_initiation", "account_information", "money_remittance"],
    matchedJurisdictions: ["eu", "eba"],
    matchedHomeJurisdictions: [],
    matchedPassportJurisdictions: ["eu"],
    matchedTopics: ["consumer_protection.retail_disclosure", "conduct.complaints_handling"],
    criticalProductLineMatched: true,
    rawImpactScore: 76,
    impactFloorAdjustment: 0,
    scoringRuleVersion: "mvp-seed-v0",
  ...
  {
    id: "pub-ecb-prudential-srep",
    title: "Synthetic ECB supervisory priorities for SREP, liquidity and governance",
    sourceCode: "ecb",
    sourceName: "ECB Banking Supervision",
    sourceUrl: "https://www.bankingsupervision.europa.eu/banking/priorities/html/index.en.html",
    publicationType: "thematic_review_findings",
    publishedAt: "2026-05-24T08:00:00.000Z",
    fetchedAt: "2026-05-24T08:20:00.000Z",
    language: "en",
    bodyText:
      "Synthetic prudential publication for demo use. The publication highlights SREP governance, liquidity risk, own funds planning, large exposures and management body accountability for supervised credit institutions.",
    tags: {
      regulationFamilies: ["prudential_banks"],
      activities: ["deposit_taking", "lending_fiat"],
      licenceTypes: ["credit_institution_crr"],
      topicPaths: ["prudential.liquidity", "prudential.own_funds", "outsourcing_and_governance.board_composition"],
      jurisdictions: ["eu", "ecb_banking_supervision_ssm"],
    },
    confidence: 0.77,
    classifierModel: "deterministic-keyword-rules",
    classifierVersion: "stub:keyword-rules-v1",
    ...
    impactScore: 61,
    summary:
      "Synthetic ECB prudential publication used to test SREP, liquidity and bank-governance routing.",
    whatChanged:
      "The demo item expands the scanner beyond crypto, payments and DORA into prudential supervision.",
    whoIsAffected:
      "Credit institutions, banking product owners, risk functions and governance teams.",
    recommendedAction:
      "Assess whether SREP, liquidity and management body evidence should enter the reviewer queue.",
    serviceOfferingIds: ["gc_regulatory_strategy_retainer"],
    rawHash: "demo-ecb-prudential-srep",
    scoreRationale:
      "Licence match: credit_institution_crr; topic overlap: prudential.liquidity, prudential.own_funds.",
    matchedLicences: ["credit_institution_crr"],
    matchedActivities: ["deposit_taking", "lending_fiat"],
    matchedJurisdictions: ["eu", "ecb_banking_supervision_ssm"],
    matchedHomeJurisdictions: [],
    matchedPassportJurisdictions: ["eu"],
    matchedTopics: ["prudential.liquidity", "prudential.own_funds"],
    criticalProductLineMatched: false,
    rawImpactScore: 61,
    impactFloorAdjustment: 0,
    scoringRuleVersion: "mvp-seed-v0",
  ...
  {
    id: "pub-commission-ai-act-gpai",
    title: "Synthetic Commission notice on AI Act GPAI and high-risk implementation",
    sourceCode: "european_commission",
    ...
    fetchedAt: "2026-05-28T11:25:00.000Z",
    language: "en",
    bodyText:
      "Synthetic AI regulation publication for demo use. The notice summarizes AI Act implementation topics for GPAI obligations, high-risk systems, transparency and sandbox participation.",
    tags: {
      regulationFamilies: ["ai_act"],
      activities: ["reference_data_provision"],
      licenceTypes: ["none_unregulated"],
      topicPaths: ["conduct.product_governance"],
      jurisdictions: ["eu", "european_commission"],
    },
    confidence: 0.69,
    classifierModel: "deterministic-keyword-rules",
    classifierVersion: "stub:keyword-rules-v1",
    ...
    impactScore: 58,
    summary:
      "Synthetic Commission AI Act publication used to test AI regulation monitoring alongside financial regulation.",
    whatChanged:
      "The demo item adds AI Act routing for governance teams that monitor regulated AI product exposure.",
    whoIsAffected:
      "AI SaaS teams, regulated financial institutions using AI systems, product counsel and model governance owners.",
    recommendedAction:
      "Route to AI governance review and decide whether a product-map watchlist update is required.",
    serviceOfferingIds: ["gc_regulatory_strategy_retainer"],
    rawHash: "demo-commission-ai-act-gpai",
    scoreRationale:
      "Regulation match: ai_act; jurisdiction overlap: eu and European Commission; topic overlap: product governance.",
    matchedLicences: ["none_unregulated"],
    matchedActivities: ["reference_data_provision"],
    matchedJurisdictions: ["eu", "european_commission"],
    matchedHomeJurisdictions: [],
    matchedPassportJurisdictions: ["eu"],
    matchedTopics: ["conduct.product_governance"],
    criticalProductLineMatched: false,
    rawImpactScore: 58,
    impactFloorAdjustment: 0,
    scoringRuleVersion: "mvp-seed-v0",
...
export const mockVersions: Record<string, PublicationVersionView[]> = {
  "pub-esma-qa-2845": [
    ...
    },
    {
      ...
      fetchedAt: "2026-05-20T00:35:00.000Z",
      rawHash: "demo-esma-qa-2845",
      changeSummary: "Fixture publication has no prior version in the synthetic data set.",
      diffFromPrevious:
